...
function SearchInput(props: Props) {
  ...
  return (
    <input
      type="text"
      placeholder="🔎 Hledat..."
      className={`py-1.5 px-5 mr-2 bg-gradient-to-r ${selectedClass} rounded-full text-white flex justify-between h-[36px] focus:outline outline-offset-2 outline-1 outline-purple-600`}
